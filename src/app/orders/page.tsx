    ...
    <div className="page">
      ...
      <div className="space-y-4">
        {orders.map((order) => (
          <div
            key={order._id}
            className="bg-white border border-gray-300 overflow-hidden shadow-sm rounded-lg"
          >
            <div className="p-6">
              {/* Ürün Listesi */}
              ...
              <div className="grid md:grid-cols-2 gap-4 py-4 border-t border-gray-200">
                <div className="flex items-center gap-3">
                  <FaPhone className="text-green-600 mt-7" />
                  <div>
                    <h5 className="text-sm text-gray-500">Müşteri</h5>
                    <div className="border mb-2 h-px text-gray-200"></div>
