...
const Hero: FC = () => {
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 text-white">
      ...
      <div className="flex flex-col justify-between p-6 rounded-lg bg-linear-to-r from-orange-600 to-orange-700 max-md:hidden">
        ...
        <button className="bg-white inline-block w-fit text-orange-700 py-2 px-4 rounded-md hover:bg-orange-50 transition cursor-pointer">
          Alışverişe başla
        </button>
      </div>
    </div>
